...
#
# Generated by export_simulation on Thu Jan 19 13:03:42 CET 2017
#
################################################################################
...
switch to the './Count_0.sh' script.

./Count_0.sh -reset_run
...
./Count_0.sh -noclean_files

For more information on the script, please type './Count_0.sh -help'.
