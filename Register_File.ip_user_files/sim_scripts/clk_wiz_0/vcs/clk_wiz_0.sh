...
#
# Generated by Vivado on Fri Mar 10 10:24:11 UTC 2017
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../Register_File.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../Register_File.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/media/arsanios/myNtfs/Xilinx/DATA/Tesi/Projects/Register File/Register_File_1.0/Register_File.cache/compile_simlib/vcs"
  fi
