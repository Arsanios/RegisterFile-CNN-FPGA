...
HD_PWD='/media/arsanios/myNtfs/Xilinx/DATA/Tesi/Projects/Register File/Register_File_Final/Register_File.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Collection.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Collection.tcl
