...
HD_PWD='/home/ayoub/Register_File/Register_File.runs/Count_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Count_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Count_0.tcl
